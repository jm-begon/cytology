...
import numpy as np
from imageconverter import NumpyConverter
import math
...
class ColorDeconvoluter:
    ...
    kernel : 2D numpy.ndarray with dtype=float
            The instance kernel used for the color deconvolution.
            It must be 3x3, regular and its value should be in the range
            [0, 255].
    """
