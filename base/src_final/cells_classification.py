...
image_id = 37167205 
job_id = 59645423 # job d'area classification ou de cluster segmentation

model_job_data = 2017481

model_filepath = "/tmp/model-thyroid-inclusion-GRAY-july2013.pkl"
term_to_classify = 15054765 #cells to classify
gray = False
...
folder_name = "./crops"+"-cells-" + str(job_id) + "/0/"
...
#teléchargement et prétraitement des crops d'annotation
